 ...
 // List of pages and their titles
    ...
    $subpages = [
        'about'=>[
            'team'=>'Team',
            'partners'=>'Partners',
            'evolution' => 'An open and evolving tool',
        ],
    ...
    $pageSEO = [
        ...
        'evolution'=>['title'=>'Mobiliscope - an open-source geovisualization tool ','meta'=>'A free and open-source web mapping platform licensed under the GNU GPLv3 license (a free, copyleft license). Scripts are available on Github.'],
