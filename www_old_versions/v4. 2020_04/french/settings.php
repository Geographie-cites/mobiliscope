 ...
 // List of pages and their titles
    ...
    // META it should be max 230 char
      ...
      $pageSEO = [
        ...
        'summary'=>['title'=>'Le Mobiliscope pour explorer la population des villes le jour et la nuit !','meta'=>'La mobilité quotidienne des populations occasionne des évolutions dans la compostion sociale des qaurtiers et dans la segergation des villes au corus des 24 heures de la journée. '],
		'team'=>['title'=>'Le Mobiliscope – un outil développé au laboratoire Géographie-cités','meta'=>'Un outil de géovisualisation sous la responsabilité de Julie Vallée et développé par Aurélie Douet et Constance Lecomte. Avec la participation de Guillaume Le Roux, Hadrien Commenges et E. Villard'],
        'partners'=>['title'=>'Le Mobiliscope – un labo de recherche, plusierus partenaires','meta'=>'Développé dans le laboratoire Géographie-cités, le Mobiliscope est souetnu par le CNRS, l\'ANCT, le Cerema et le Labex DynamiTe.'],
        ...
        'scientific-tool'=>['title'=>'Le Mobiliscope - un outil scientifique','meta'=>'Pour explorer  et les effets de lieu au quotidien. Pour sortir d’une approche statique de la justice spatiale.'],
