...
var discretMethod = ['</br>Discrétisation en quintiles. ',
					 '</br>Discrétisation manuelle. ',
					 '</br>Discrétisation en amplitude égale. ',
					 '</br>Discrétisation selon les seuils naturels. '];
var textLegChoro = ["Pour chaque modalité, les intervalles de classes restent identiques sur les 24h pour une même région.",
					...
					"Les intervalles de classe restent identiques sur les 24h pour toutes les villes latino-américaines."];
