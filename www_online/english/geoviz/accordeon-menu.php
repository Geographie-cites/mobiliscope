...
<div class = "niv1"><p>SOCIAL PROFILE</p></div>    
	...
	<div class = "niv2"><p>Household income<span class = "helpAcc" onclick = "popup_rev_fr()">Q</span></p></div>
...
<div class = "niv1"><p>SOCIAL PROFILE</p></div>    
	...
	<div class = "niv2"><p>Household income<span class = "helpAcc" onclick = "popup_rev_can()">Q</span></p></div>
		...
		<div class = "niv3" style = "border-left-color : #348e89 ;"><p>Low</p><button id = "first" class ="part" onclick = "rev1_choro()">%</button><button class ="nb" onclick = "rev1_prop()">nb</button><button class ="flow" onclick = "rev1_flow()">✴</button></div>
	  	...
	  	<div class = "niv3" style = "border-left-color: #4b4443 ;"><p>Missing</p><button class ="part" onclick = "rev5_choro()">%</button><button class ="nb" onclick = "rev5_prop()">nb</button><button class ="flow" onclick = "rev5_flow()">✴</button></div>
