...
$cancities = [
 ...
 // List of pages and their titles
    ...
    $pageSEO = [
        ...
        'summary'=>['title'=>'Mobiliscope – To explore daytime and nighttime population in cities !','meta'=>'Cities are not static over the 24h period... Neighborhoods, social mix and urban segregation change according to people\'s daily mobility and theyr everyday geography.'],
        ...
        'planning-tool'=>['title'=>'Le Mobiliscope – a planning tool ','meta'=>'Where? ? When? Who ? How ? To do what time? These questions are frequent in urban planning. Policymakers can find some answers in the Mobiliscope using interactive platfom.'],
