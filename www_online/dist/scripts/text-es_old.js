...
// Textes des légendes
var discretMethod = {quintiles:'</br>Clasificación en quintiles. ',
					 manuelle:'</br>Clasificación manual. ',
					 amplEg:'</br>Clasificación de igual amplitud. ',
					 seuilNat:'</br>Clasificación de rupturas naturales (Jenks). ',
					 sd:"</br>Discrétisation selon la moyenne et l'écart-type. ",
					 nestedAve:'Clasificación para promedios anidados. ',
					 arithmProg:'</br>Discrétisation par progression arithmétique. '};
var textCompar = ["Las clases se mantienen idénticas durante las 24 horas para la misma región.",
				  "Para cada modalidad, los intervalos de clase se mantienen idénticos a lo largo de las 24 horas para la misma región.",
