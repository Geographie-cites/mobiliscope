 ...
 // List of pages and their titles
    ...
    $subpages = [
        'about'=>[
			...
			'evolution'=>'Un outil libre en évolution',
    ...
    // META it should be max 230 char
      ...
      $pageSEO = [
        ...
        'partners'=>['title'=>'Le Mobiliscope – un labo de recherche, plusierus partenaires','meta'=>'Développé dans le laboratoire Géographie-cités, le Mobiliscope a reçu le soutien du  CNRS, de l\'ANCT (ex-CGET CGET) et du Labex DynamiTe.'],
        'evolution'=>['title'=>'Le Mobiliscope, un outil libre de géovisualisation','meta'=>'Développé avec des technologies libres et open source (javascript, libraire D3.js), proposé sous licence libre (GNU GPL v3.0) et reproductible à partir des scripts déposés sur github'],
