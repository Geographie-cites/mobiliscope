<div class = "corps">
	...
	<p>
	Il peut constituer un support ludique pour faire explorer aux élèves les différents types de déplacements (pendulaires, ponctuels et réguliers) et les fonctions urbaines&nbsp;: deux thématiques présentes dans le <b>programme de géographie de CM2</b>.
	</p>

	<p>
	Le Mobiliscope a été présenté à plusieurs reprises à des classes de CM2 à Paris et à Toulouse. A partir de tablettes ou d'ordinateurs, le Mobiliscope a permis aux élèves de répondre à un petit <b>quizz</b>.
	</p>
	...
	<p>
	Exemple des questions proposées aux élèves de CM2 d'une école située dans le 20ème arrondissement à Paris&nbsp;:
	<ul>
	...
	<p>
	Le Mobiliscope a été utilisé par <a href = "https://histoire.ac-versailles.fr/spip.php?article1718" target="_blank">des professeurs d'histoire-géographie de lycée de l'académie de Versailles </a> pour l'étude des mobilités en Île-de-France <b>en classe de première</b>&nbsp;:</br>
	...
	<section>
     <h3>Faites-nous part de vos expériences pédagogiques !</h3>
    <p>
		N'hésitez pas à nous envoyer un message pour partager vos expériences du Mobiliscope à l'école primaire, au collège, au lycée ou à l'université. Nous sommes très intéressés par vos retours. </br>
		Et nous pouvons aussi vous accompagner dans la mise en place d'actions pédagogiques spécifiques autour de votre quartier, votre ville... 
    </p>
	</section>
