	...
	<div id="container">
		...
		<div id="geoviz-container">
			...
			<div  id="container-timeline">
				...
				<label for="help-modal-control" data-tooltip="left 1000" aria-label="Aide sur l'application">
					<img class="ask" src="/dist/assets/ask.svg"/>
				</label>
				<label for="share-modal-control" data-tooltip="left 1000" aria-label="Partager cette vue">
				...
				<div id = "graphiques">
					...
					<div class="graphiques-bloc1">
						<div id = "mainGr1Cont">
							...
							<a id = "segreg-dowload" class="mainGr1-tooltip" data-tooltip="down 1000" aria-label="Téléchargement"></a>
						</div>
