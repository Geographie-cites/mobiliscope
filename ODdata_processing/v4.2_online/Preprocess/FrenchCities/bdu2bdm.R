...
# tripTable <- readRDS("BD_mobiliscope_depl.RDS")
...
## save
# saveRDS(tripTable, "BD_mobiliscope_depl.RDS")
...
# Chargement de la BD Mobiliscope
# tripTable <- readRDS("BD_mobiliscope_depl.RDS")
# indTable <- readRDS("BD_mobiliscope_pers.RDS")
...
## 6. Ajout de STRM
strm <- read.csv2("txt/STRM_fr.csv", colClasses = "character")
