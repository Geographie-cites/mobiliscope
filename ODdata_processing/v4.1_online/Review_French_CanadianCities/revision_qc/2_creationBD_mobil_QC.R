...
correspMotif <- read.csv2("~/git/mobiliscope/ODdata_processing/v4.0/Preprocessing_CanadianCities/correspondance_motif_can.csv",
...
correspOcc <- read.csv2("~/git/mobiliscope/ODdata_processing/v4.0/Preprocessing_CanadianCities/correspondance_occ_can.csv", 
...
##~ STRM
strm <- read.csv2("~/git/mobiliscope/ODdata_processing/v4.1_online/Review_French_CanadianCities/revision_qc/STRM_qc.csv", colClasses = "character")
