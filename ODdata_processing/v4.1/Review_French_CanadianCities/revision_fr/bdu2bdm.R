...
#
# juillet 2020 - AD
# rv jan. 2022 : ajout de la variable "STRM" (composition du ménage) construite dans 
...
## ZONAGE_SEC ---
## (variable construite dans le script 2a_zonage_residentialArea.R)
...
## Sauvegarde BD déplacement ---
# saveRDS(tripTable, file = "02_PREPA_DATA/data/bd/02_bdm/BD_mobiliscope_depl.RDS")
...
## stockage de la table personne brute 
pers <- indTable
...
## variable "ZONAGE_SEC" ---
## construite dans le script 2a_zonage_residentialArea.R
...
## Sauvegarde ---
# saveRDS(indTable, file = "02_PREPA_DATA/data/bd/02_bdm/BD_mobiliscope_pers.RDS")
...
# tripTable <- readRDS("02_PREPA_DATA/data/bd/02_bdm/BD_mobiliscope_depl.RDS")
# indTable <- readRDS("02_PREPA_DATA/data/bd/02_bdm/BD_mobiliscope_pers.RDS")
...
## save
# saveRDS(tripTable, "02_PREPA_DATA/data/bd/02_bdm/BD_mobiliscope_depl.RDS")
...
### Chargement de la base de données unifiée du CEREMA
#BDUdepl <- readRDS("02_PREPA_DATA/data/bd/01_bdu/BDU_cerema_depl.RDS")
...
## 6. Ajout de STRM
strm <- read.csv2("../../v4.1_online/Review_French_CanadianCities/revision_fr/STRM_fr.csv", colClasses = "character")

strm <- strm %>% rename(STRM = STRMfr)
