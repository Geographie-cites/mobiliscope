...
<div class="topbar">
    ...
    <div class = "row full-menu">
        <div class = "col-sm-10 col-sm-offset-1">
            ...
            <div class = "row">
            <?php
                echo "<h3>Liste des villes/régions";
            ?>
            </div>
...
<div>
  <div class="card help-card">
    ...
    <h4>1) Sélectionnez une carte</h4>
    ...
    <h4>2) Observez l'évolution de la carte au fil de la journée</h4>
    ...
    <h4>3) Observez un secteur en particulier</h4>
    ...
    <h4>4) Observez la ségrégation spatiale</h4>
    ...
    <h4>Observez une autre ville</h4>
	
	 <h4>5) Observez les </h4>
    ...
    <p class="section">
        22 villes françaises et leur périphérie sont incluses dans la version actuelle du Mobiliscope (2019). Pour observer une autre ville, utlisez l'outil loupe <i class="fas fa-search"></i><br /><br />
    </p>
