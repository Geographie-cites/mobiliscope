...
<div>
  <div class="card help-card">
    ...
    <h4>2) Map at different times of the day</h4>
    ...
    <h4>3) Explore one specific district</h4>
    ...
    <h4>4) Explore spatial segregation</h4>
    ...
    <h4>To access another city region</h4>

    <p class="section">
        21 french city region are included in the actual version of the Mobiliscope(2019). To access another city region, use magnify tool <i class="fas fa-search"></i><br /><br />
    </p>
